...
$query_rq_prof = $dbh->query("SELECT DISTINCT INDIVIDU.IDINDIVIDU, `MATRICULE`, `NOM`, `PRENOMS`, `DATNAISSANCE`, `ADRES`, `TELMOBILE`, `TELDOM`, `COURRIEL`, `LOGIN`, `MP`, `CODE`, `BIOGRAPHIE`, `PHOTO_FACE`, `IDTYPEINDIVIDU`, `SEXE`, `IDTUTEUR`, `LIEN_PARENTE`, `ANNEEBAC`, `NATIONNALITE`, `SIT_MATRIMONIAL`, `NUMID`, `IDSECTEUR`, `LIEU_TRAVAIL`, `PATHOLOGIE`, `ALLERGIE`, `MEDECIN_TRAITANT`, `FICHE_RECTO`, `FICHE_VERSO` FROM `INDIVIDU` 
...
WHERE INDIVIDU.IDETABLISSEMENT = " . $colname_rq_etablissement . " AND IDTYPEINDIVIDU=7 AND CLASSROOM.IDNIVEAU=".$NIVEAUX);

$query_rq_prof2 = $dbh->query("SELECT DISTINCT INDIVIDU.IDINDIVIDU, `MATRICULE`, `NOM`, `PRENOMS`, `DATNAISSANCE`, `ADRES`, `TELMOBILE`, `TELDOM`, `COURRIEL`, `LOGIN`, `MP`, `CODE`, `BIOGRAPHIE`, `PHOTO_FACE`, `IDTYPEINDIVIDU`, `SEXE`, `IDTUTEUR`, `LIEN_PARENTE`, `ANNEEBAC`, `NATIONNALITE`, `SIT_MATRIMONIAL`, `NUMID`, `IDSECTEUR`, `LIEU_TRAVAIL`, `PATHOLOGIE`, `ALLERGIE`, `MEDECIN_TRAITANT`, `FICHE_RECTO`, `FICHE_VERSO` FROM `INDIVIDU` 
INNER JOIN RECRUTE_PROF ON RECRUTE_PROF.IDINDIVIDU=INDIVIDU.IDINDIVIDU 
INNER JOIN CLASSE_ENSEIGNE ON CLASSE_ENSEIGNE.IDRECRUTE_PROF =RECRUTE_PROF.IDRECRUTE_PROF 
INNER JOIN CLASSROOM ON CLASSROOM.IDCLASSROOM =CLASSE_ENSEIGNE.IDCLASSROM 
WHERE INDIVIDU.IDETABLISSEMENT = " . $colname_rq_etablissement . " AND IDTYPEINDIVIDU=7 AND CLASSROOM.IDNIVEAU=".$NIVEAUX);
